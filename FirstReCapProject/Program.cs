 ...
 *Ödevde gereksinimleri tam anlamadığınız durum benim için önemli değil,
...
silebileceği bir ortamı simule ediniz. 
...
class Program
{
    static void Main(string[] args)
    {
        ...
        person.NationalId = 1;
        person.FirstName = "Onur Kerem";
        person.LastName = "Bozkurt";
        ...
        discountManager.GetDiscount(person);
